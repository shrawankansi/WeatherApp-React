...
export default function Home() {
  ...
  const api_key ='c05c9a46370c48a6a0042935230607'
...
const handleKeyUp = (key) => {
  if (key === "Enter") {
    getWeather()
       ...
       return (
    <>
        <nav className="flex items-center justify-center py-4 bg-gray-200 w-full m-0 opacity-90">
        ...
        <div className="flex justify-center p-20 pt-20 mt-20">
          <div className="flex bg-white rounded-3xl px-4 py-1 color-gray opacity-90 hover:scale-150 transition-all">
            <img className="codrkai-profile object-cover rounded-full w-16 h-16 m-2" src="https://avatars.githubusercontent.com/shrawankansi" alt="shrawankansi" />
            <div className="text-sm text-gray-400 pt-3">shrawankansi<br />WeatherApp<br />&copy; 2023</div>
          </div>
        </div>
    </>
  )
